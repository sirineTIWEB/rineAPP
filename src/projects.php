...
<section class="md:h-[500px] h-[25vh] bg-myyellow dark:bg-mylightblue flex items-end md:mb-64 mb-32">
    <div class="pl-10 md:pl-20 pb-10 md:pb-20">
        ...
        <h2 class="texte text-mybeige dark:text-mydarkblue max-w-56">
            <?php esc_html_e('A selection of proud/unproud projects, fictionnal or not, and everything in between.', 'rine2'); ?>
        </h2>
    </div>
...
<section
    class="bg-[linear-gradient(to_right,#F2DA91_1.5px,transparent_1.5px),linear-gradient(to_bottom,#F2DA91_1.5px,transparent_1.5px)] md:bg-[size:30px_30px] bg-[size:20px_20px] z-[-1] border-b-[1.5px] border-myyellow md:p-14 p-7 mb-11 flex flex-wrap gap-5 md:gap-10 justify-center">
