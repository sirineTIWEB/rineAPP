<?php get_header() ?>
    ...
    <section class="sm:h-[500px] h-[25vh] bg-myyellow flex items-end sm:mb-64 mb-32">
        <div class="pl-10 sm:pl-20 pb-10 sm:pb-20">
            <h1 class="text-mybeige titre">rine's projects</h1>
            <h2 class="texte text-mybeige max-w-56">A selection of proud/unproud projects, fictionnal or not, and everything in between.</h2>
        </div>
        <img class="absolute sm:right-1/3 sm:bottom-0 top-[15.5rem] right-24 h-16 sm:h-auto" src="assets/icons/projets.svg" alt="gribouilli4">
    </section>
    <section class="sm:ml-12 ml-6 mb-20">
        <h1 class="titre text-mydarkblue">catégories</h1>
