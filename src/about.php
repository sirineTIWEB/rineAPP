...
*/
get_header(); ?>
    <section class="md:h-[500px] h-[25vh] bg-myyellow flex items-end md:mb-64 mb-32">
        ...
        <img class="absolute md:right-1/3 md:bottom-0 top-[15.5rem] right-24 h-16 md:h-auto" src="<?php echo get_template_directory_uri(); ?>/assets/icons/profile.svg" alt="gribouilli4">
    </section>
    <section class="flex flex-col items-center mb-16 md:mb-52">
        <h1 class="titre text-myyellow mb-6 md:mb-8 flex-wrap"><?php esc_html_e('work experiences', 'rine2'); ?></h1>
    ...
    <section class="relative flex justify-end h-[80vh] p-12 md:mb-60 mb-20">
        ...
        <div id="flowerZone3" class="absolute top-28 md:bottom-1/4 md:left-96"> <img class="md:h-auto h-32" src="assets/icons/fleur4.svg" alt="little dark blue flower"></div>
    ...
    <section class="w-full h-[50vh] flex flex-col md:flex-row md:mb-56 mb-20">
        ...
        <div class="h-1/2 md:h-auto md:w-1/2 bg-mydarkblue dark:bg-myyellow flex flex-col items-start justify-end pl-6">
            <h1 class="soustitre md:w-1/2 w-2/3 text-mybeige dark:text-mylightblue text-end"><?php printf(__('Want  to see <br> more <span class="titre">PROJECTS?</span>', 'rine2')); ?></h1>
