<?php get_header() ?>
    ...
    <section class="flex flex-col justify-evenly sm:flex-row text-mydarkblue bg-myyellow h-[60vh] mb-[20vh]">
        <div class="flex flex-col sm:justify-center sm:items-start items-end sm:w-1/2 sm:pl-20">
            <h1 class="text-3xl sm:text-6xl w-1/2 font-aqva uppercase sm:w-[60%]">get in touch with me!</h1>
            <p class="texte sm:w-1/2 w-2/3">Got a project or question in mind? Reach out — every message is reviewed and answered as quickly as possible.</p>
        </div>
        <div class="flex relative pl-4 sm:pl-0 flex-col justify-center sm:w-1/2">
            <form action="">
                ...
                <button type="submit" class="">
                    <img class="absolute sm:right-20 sm:top-96 top-40 right-24 h-16 sm:h-auto" src="assets/icons/send.svg" alt="send button">
                </button>
